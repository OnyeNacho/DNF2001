...
simulated event RenderOverlays( canvas Canvas )
{
	...
	// TODO: there's probably a better way to do this, this stinks - x
	...
	if ( UseSpriteFlash && (MuzzleFlashSprite != None) )
	{
		...
		Canvas.SetPos(SpriteFlashX*PlayerOwner.MyHUD.HUDScaleX * scalex, SpriteFlashY*PlayerOwner.MyHUD.HUDScaleY * scaley);
		if ( bMultiFrameFlash )
		{
			if (Level.TimeSeconds - MuzzleFlashTime < MuzzleFlashLength/2)
				Canvas.DrawTile(MuzzleFlashSprites[0], MuzzleFlashSprite.USize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX * scalex, MuzzleFlashSprite.VSize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY * scaley, 0, 0, MuzzleFlashSprite.USize, MuzzleFlashSprite.VSize, MuzzleFlashRotation + Rand(360));
			else if	(Level.TimeSeconds - MuzzleFlashTime < MuzzleFlashLength)
				Canvas.DrawTile(MuzzleFlashSprites[1], MuzzleFlashSprite.USize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX * scalex, MuzzleFlashSprite.VSize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY * scaley, 0, 0, MuzzleFlashSprite.USize, MuzzleFlashSprite.VSize, MuzzleFlashRotation + Rand(360));
		}
		else if (Level.TimeSeconds - MuzzleFlashTime < MuzzleFlashLength)
			Canvas.DrawTile(MuzzleFlashSprite, MuzzleFlashSprite.USize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX * scalex, MuzzleFlashSprite.VSize * MuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY * scaley, 0, 0, MuzzleFlashSprite.USize, MuzzleFlashSprite.VSize, MuzzleFlashRotation + Rand(360));
	...
	if ( UseAltSpriteFlash && (AltMuzzleFlashSprite != None) )
	{
		...
		Canvas.Style = ERenderStyle.STY_Translucent;
		Canvas.SetPos(AltSpriteFlashX*PlayerOwner.MyHUD.HUDScaleX * scalex, AltSpriteFlashY*PlayerOwner.MyHUD.HUDScaleY * scaley);
		if ( bAltMultiFrameFlash )
		{
			if (Level.TimeSeconds - AltMuzzleFlashTime < AltMuzzleFlashLength/2)
				Canvas.DrawTile(AltMuzzleFlashSprites[0], AltMuzzleFlashSprite.USize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX, AltMuzzleFlashSprite.VSize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY, 0, 0, AltMuzzleFlashSprite.USize, AltMuzzleFlashSprite.VSize, AltMuzzleFlashRotation + Rand(360));
			else if	(Level.TimeSeconds - AltMuzzleFlashTime < AltMuzzleFlashLength)
				Canvas.DrawTile(AltMuzzleFlashSprites[1], AltMuzzleFlashSprite.USize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX, AltMuzzleFlashSprite.VSize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY, 0, 0, AltMuzzleFlashSprite.USize, AltMuzzleFlashSprite.VSize, AltMuzzleFlashRotation + Rand(360));
		}
		else if (Level.TimeSeconds - AltMuzzleFlashTime < AltMuzzleFlashLength)
			Canvas.DrawTile(AltMuzzleFlashSprite, AltMuzzleFlashSprite.USize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleX, AltMuzzleFlashSprite.VSize * AltMuzzleFlashScale * PlayerOwner.MyHUD.HUDScaleY, 0, 0, AltMuzzleFlashSprite.USize, AltMuzzleFlashSprite.VSize, AltMuzzleFlashRotation + Rand(360), , , true);
		Canvas.Style = ERenderStyle.STY_Normal;
	}
